# Stakeholder Needs and Requirements Definition (§6.4.2)
...
The four SN&RD-specific diagrams from Week 3 are in `Diagrams/`:

- `snrd_ipo.svg` — SN&RD inputs/processing/outputs
- `stakeholder_power_interest.svg` — stakeholder identification grid
- `requirements_hierarchy.svg` — mission → business → stakeholder → system → subsystem
- `validation_vs_verification.svg` — V&V distinction (forward-looking; expanded in CH03 Verification & Validation folders)
